...
public class ReservationController {
    ...
    public void process()
    {
        ...
        {
            Main.clrscr();
            displayService.afficherMenuReservation();
            choix = scannerMenuService.faireChoixSousMenu(5);
            switch(choix)
            {
                case 1:
                    Main.clrscr();
                    scannerMenuService.ajoutReservation();
                    break;
                case 2:
                    Main.clrscr();
                ...
                case 3:
                    Main.clrscr();
                    scannerMenuService.rechercherReservation();
                    scannerMenuService.pause();
                    break;
                case 4:
                    Main.clrscr();
                    scannerMenuService.supprimerReservation();
                    break;
            }
        }
    }
